          ...
          {benefits.map((benefit, index) => (
            ...
            >
              <Card className="group relative h-full overflow-hidden border-2 bg-card/50 backdrop-blur transition-all hover:border-primary/50 hover:shadow-xl">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-[#eb5160]/5 to-[#b7999c]/5 opacity-0 transition-opacity group-hover:opacity-100" />

                <CardContent className="relative p-6">
                  <div className="mb-4 flex items-start justify-between">
                    <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-[#071013] to-[#eb5160]">
